...
class __TwigTemplate_1d826339cd9f17327a72fbc965afdcc1538650e0ecf473bf5d9bb55fa30d10c8 extends Twig_Template
{
    ...
    <div class=\"panel-body\" id=\"panelbody\">
        <h3>DEVELOPPEUR SQL/XML BILINGUE ANGLAIS</h3>
        <p>Description de l'entreprise :Un des premiers groupes de services financiers de la zone euro. Parce qu'il n'y a pas de succès collectif sans r&e...</p>
    </div>
    <div class=\"panel-body\" id=\"panelbody\">
        <h3>TECHNICIEN SUPPORT HOTLINE</h3>
        <p>Groupe familial Français qui regroupe différentes enseignes (Loisirs & Création, Rue de la Fête, La Grande Récr&...</p>
    </div>
    <div class=\"panel-body\" id=\"panelbody\">
        <h3>ADMINISTRATEUR SYSTEMES ET RESEAUX</h3>
        <p>Connaissances et savoir-faire : Environnement technique réseau - maîtrise des protocoles/services d’infrastructures LAN et WAN (D...</p>
    </div>
</div>";
    }
