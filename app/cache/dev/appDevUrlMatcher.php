...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // ingetis_demande_doc_DDD
        if (rtrim($pathinfo, '/') === '/DDD') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'ingetis_demande_doc_DDD');
            }

            return array (  '_controller' => 'Ingetis\\DemandeDocBundle\\Controller\\DefaultController::DDDAction',  '_route' => 'ingetis_demande_doc_DDD',);
        }
        ...
        if (rtrim($pathinfo, '/') === '/admin') {
            ...
            return array (  '_controller' => 'Ingetis\\SiteBundle\\Controller\\DefaultController::adminAction',  '_route' => 'ingetis_site_homepage',);
        }
